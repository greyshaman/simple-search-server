...
Для того чтобы использовать поисковый движок нужно собрать проект и установить его.
...
так же возможно использование в виде подпроекта. Путём копирования каталога проекта поискового движка в корень другого разрабатываемого проекта:
